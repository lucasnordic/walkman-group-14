    ...
    <table class="table table-striped">
      ...
      <tbody>
        <tr v-for="pet in pets" :key="pet._id">
          ...
          <td>{{ pet.petItems }}</td>
          <td>
            <b-button id="pet-btn" variant="primary" @click="openForm()"
              >Edit Not Working</b-button
            >
          </td>
          <td>
            <b-button @click="deletePet(pet._id)" id="pet-btn" variant="danger"
              >Delete</b-button
            >
          </td>
        </tr>
    ...
    <div id="newPet">
      <b-jumbotron>
        ...
        <form>
          ...
          <b-button id="registration" variant="success" @click="addPet()"
            >Submit</b-button
          >
        </form>
      </b-jumbotron>
...
export default {
  name: 'pets',
  mounted() {
    Api.get('/petowners/' + this.$route.params.id + '/pets').then(res => {
      console.log(res)
      this.pets = res.data
    })
  },
  ...
  methods: {
    ...
    addPet() {
      Api.post('/petowners/' + this.$route.params.id + '/pets', this.pet).then(
        res => this.pets
      )
    },
    /* editPet(petId) {
