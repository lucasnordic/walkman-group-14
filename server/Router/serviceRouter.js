...
router.get(
	"/:petLoverId/services/:serviceId",
	controller.getServiceByPetLoverById
);
router.delete(
	"/:petLoverId/services/:serviceId",
	controller.deleteServiceByPetLoverId
);

router.put("/services/:serviceId", controller.putServiceById);
router.patch("/services/:serviceId", controller.patchServiceById);
